...
public class Game implements Serializable {
    ...
    public boolean movemenu(String input, Board game, Player CurrentPlayer) {
        ...
        if (Space.charAt(0) == 'K') {
            if (checkspaceinput(Space, "K", x, y) == true) {
            ...
            if (checkspaceinput(Space, "Q", x, y) == true) {
            ...
            if (CurrentPlayer == Black){
                ...
                if (checkspaceinput(Space, "BB", x, y) == true) {
            ...
            else if (checkspaceinput(Space, "B", x, y) == true) {
            ...
            if (checkspaceinput(Space, "N", x, y) == true) {
            ...
            if (checkspaceinput(Space, "R", x, y) == true) {
    ...
    public boolean checkspaceinput(String Space, String Name, int x, int y) {
